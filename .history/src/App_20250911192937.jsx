        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <img src={Demo4Left} alt="Customization Left" className="w-full max-w-[500px] h-auto object-contain" />
              ...
              <img src={Demo4Right} alt="Customization Right" className="w-full max-w-[500px] h-auto object-contain" />
            </div>
          </div>
        </section>
