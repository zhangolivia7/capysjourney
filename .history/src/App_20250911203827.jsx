      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <section className="relative w-full flex flex-col" style={{ background: brandCream }}>
          <div className="flex-1 flex flex-col justify-between" style={{ background: brandCream }}>
            ...
            <div className="px-6 flex justify-center mb-16">
              <p className="max-w-[1015px] text-xl md:text-2xl text-right" style={{ color: brandBrown }}>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <p className="text-2xl md:text-3xl" style={{ color: brandBrown }}>Over __ fun, expert-certified level to play through.</p>
          </div>
        </section>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <p className="text-2xl md:text-3xl" style={{ color: brandBrown }}>Complete daily wellness activities for rewards or create your own meditation!</p>
          </div>
        </section>
