  ...
  return (
    <div className="min-h-screen w-full" style={{ background: brandCream }}>
      ...
      <section className="relative w-full flex flex-col" style={{ background: brandCream }}>
        <div className="mx-auto max-w-[1440px] flex-1 flex flex-col justify-between" style={{ background: brandCream }}>
      ...
      <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <p className="text-2xl md:text-3xl text-right" style={{ color: brandBrown }}>Dozens of fun, expert-certified level to play and learn!</p>
          </div>
        </section>
