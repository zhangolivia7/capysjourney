      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <section className="relative w-full" style={{ background: brandCream }}>
          <div className="h-[1024px] w-full" style={{ background: brandCream }}>
            <div className="absolute inset-x-0 top-14 flex justify-center">
              <Placeholder className="w-[586px] h-[262px] rounded" label="Logo / Header Image" />
            </div>
            ...
            <div className="mt-10 flex justify-center">
              <div className="flex gap-10 items-end">
                <Placeholder className="w-[311px] h-[675px] rounded-2xl shadow" label="Phone Left" />
                <Placeholder className="w-[377px] h-[820px] rounded-2xl shadow" label="Phone Center" />
                <Placeholder className="w-[311px] h-[675px] rounded-2xl shadow" label="Phone Right" />
              </div>
            </div>
          </div>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <Placeholder className="w-[631px] h-[630px]" label="Image Placeholder" />
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Placeholder className="w-[630px] h-[630px]" label="Region 1" />
              <Placeholder className="w-[630px] h-[630px]" label="Region 2" />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <div className="grid grid-cols-2 gap-6">
              <Placeholder className="w-[613px] h-[613px]" label="Image A" />
              <Placeholder className="w-[613px] h-[613px]" label="Image B" />
            </div>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-start gap-10">
            ...
            <div className="flex-1">
              <div className="mb-6">
                <div className="inline-flex items-center justify-center rounded-[50px] border-[12px] px-6 h-[134px]" style={{ background: brandYellow, borderColor: 'white' }}>
                  <span className="text-lg font-medium" style={{ color: brandBrown }}>Let’s journey together!</span>
                </div>
              </div>
              <Placeholder className="w-[294px] h-[347px]" label="Capy Illustration" />
            </div>
          </div>
        </section>
      </div>
