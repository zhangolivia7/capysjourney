    ...
    <div className="min-h-screen bg-amber-50">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-72 h-72 bg-amber-200 rounded-full blur-3xl opacity-50 -z-10"></div>
              <div className="absolute -bottom-4 -left-4 w-72 h-72 bg-orange-200 rounded-full blur-3xl opacity-50 -z-10"></div>
              <div className="absolute top-8 left-6 w-32 h-32 bg-amber-300 rounded-full blur-3xl opacity-70 -z-10"></div>
              <div className="absolute bottom-10 right-10 w-24 h-24 bg-orange-300 rounded-full blur-3xl opacity-70 -z-10"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-transparent">
        <div className="mx-auto max-w-5xl px-6">
          ...
          {/* Video Placeholder */}
          <div className="relative aspect-video bg-gradient-to-br from-amber-200 to-orange-200 rounded-3xl overflow-hidden shadow-2xl">
            <div className="pointer-events-none absolute -top-10 -left-10 w-40 h-40 bg-amber-300 rounded-full blur-3xl opacity-70 -z-10"></div>
            <div className="pointer-events-none absolute -bottom-12 -right-8 w-32 h-32 bg-orange-300 rounded-full blur-3xl opacity-70 -z-10"></div>
