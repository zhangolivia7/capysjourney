...
import threePhonesImage from './assets/1Demo.png'
import videoImage from './assets/2Demo.png'
import region1Image from './assets/4.1Demo.png'
import region2Image from './assets/4.2Demo.png'
      ...
      <div className="mx-auto max-w-[1440px]">
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <img src={threePhonesImage} alt="Feature 1" className="w-[631px] h-[630px] object-cover"/>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <img src={region1Image} alt="Region 1" className="w-[630px] h-[630px] object-cover"/>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <img src={threePhonesImage} alt="Feature 3" className="w-[631px] h-[630px] object-cover"/>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <div className="grid grid-cols-2 gap-6">
              <img src={region1Image} alt="Feature 4a" className="w-[613px] h-[613px] object-cover"/>
              <img src={region2Image} alt="Feature 4b" className="w-[613px] h-[613px] object-cover"/>
            </div>
