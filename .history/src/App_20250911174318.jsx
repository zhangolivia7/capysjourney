        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <div className="grid grid-cols-2 gap-6">
              <img src={region41Image} alt="Feature 4a" className="w-[613px] h-[613px] object-cover"/>
              <img src={region42Image} alt="Feature 4b" className="w-[613px] h-[613px] object-cover"/>
            </div>
