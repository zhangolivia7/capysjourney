  ...
  return (
    <div className="min-h-screen bg-amber-50">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-1">
          <li><a className='text-orange-600 underline' href='https://firebase.google.com/support/privacy'>Google Analytics for Firebase</a></li>
          <li><a className='text-orange-600 underline' href='https://firebase.google.com/support/privacy'>Firebase Crashlytics</a></li>
          <li><a className='text-orange-600 underline' href='https://unity.com/legal/privacy-policy'>Unity</a></li>
          <li><a className='text-orange-600 underline' href='https://posthog.com/privacy'>PostHog</a></li>
        </ul>
