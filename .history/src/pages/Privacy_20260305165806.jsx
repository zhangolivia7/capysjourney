  ...
  return (
    <div className="min-h-screen bg-amber-50">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 text-gray-800">
        ...
        <p className="mb-8">
          If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at <a href="mailto:team@capysjourney.com">team@capysjourney.com</a>.
        </p>
