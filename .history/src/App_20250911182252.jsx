    ...
    <div className="min-h-screen w-full" style={{ background: brandCream }}>
      <div className="mx-auto max-w-[1440px]">
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <img src={Demo2} alt="Map Regions" className="w-[630px] h-[630px] object-cover" />
              <img src={Demo3} alt="Two Phones Stacked" className="w-[630px] h-[630px] object-cover" />
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-10 items-center">
            <div className="grid grid-cols-2 gap-6">
              <img src={Demo4Left} alt="Customization Left" className="w-[613px] h-[613px] object-cover" />
              <img src={Demo4Right} alt="Customization Right" className="w-[613px] h-[613px] object-cover" />
            </div>
        ...
        <section className="px-6 py-16 md:py-24" style={{ background: brandCream }}>
          <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-start gap-10">
            ...
            <div className="flex-1 flex flex-col items-center">
              ...
              <img src={Speech} alt="Capy with Speech Bubble" className="w-[294px] h-[347px] object-contain" />
            </div>
          </div>
        </section>
      </div>
