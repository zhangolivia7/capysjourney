...
export default function App() {
  return (
    <div className="min-h-screen bg-amber-50">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative isolate">
              ...
              {/* Decorative elements */}
              <div className="pointer-events-none absolute -top-8 -right-10 w-80 h-80 bg-amber-200 rounded-full blur-[90px] opacity-60 z-0"></div>
              <div className="pointer-events-none absolute -bottom-10 -left-10 w-80 h-80 bg-orange-200 rounded-full blur-[90px] opacity-55 z-0"></div>
              <div className="pointer-events-none absolute top-6 left-10 w-56 h-56 bg-amber-300 rounded-full blur-[90px] opacity-70 z-0"></div>
              <div className="pointer-events-none absolute bottom-6 right-8 w-48 h-48 bg-orange-300 rounded-full blur-[90px] opacity-65 z-0"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-b from-white via-white to-amber-50">
      ...
      <section
        className="py-20"
        style={{
          background: 'linear-gradient(to bottom, #ffffff 0%, #ffffff 18%, #fffbeb 100%)',
        }}
      >
        <div className="mx-auto max-w-5xl px-6">
          ...
          {/* Video Placeholder */}
          <div className="relative isolate">
            <div className="pointer-events-none absolute -top-12 -left-12 w-72 h-72 bg-amber-300 rounded-full blur-[90px] opacity-65 z-0"></div>
            <div className="pointer-events-none absolute -bottom-14 -right-10 w-72 h-72 bg-orange-300 rounded-full blur-[90px] opacity-60 z-0"></div>
